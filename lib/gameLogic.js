...
let AI_CHARACTERS = ['Le Chiffre', 'Vesper Lynd', 'Felix Leiter', 'Mathis', 'M'];

/**
 * Select characters for a new game
 * Le Chiffre is always included, plus 4 random others
 */
function selectGameCharacters() {
  ...
  // Le Chiffre always first
  AI_CHARACTERS = ['Le Chiffre', ...selected];
...
class PokerGame {
  constructor(playerCount = 6) {
    ...
    // Casino Royale tournament structure
    this.startingChips = 1000000; // $1 million buy-in
    this.handCount = 0;
    this.blindLevel = 0;
    // Escalating blind structure (small blind values, big blind is 2x)
    this.blindLevels = [
      5000,    // Level 0: $5,000/$10,000
      10000,   // Level 1: $10,000/$20,000
      15000,   // Level 2: $15,000/$30,000
      25000,   // Level 3: $25,000/$50,000
      50000,   // Level 4: $50,000/$100,000
      75000,   // Level 5: $75,000/$150,000
      100000,  // Level 6: $100,000/$200,000
      150000,  // Level 7: $150,000/$300,000
      200000,  // Level 8: $200,000/$400,000
      300000,  // Level 9: $300,000/$600,000
    ];
